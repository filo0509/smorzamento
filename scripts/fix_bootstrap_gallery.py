...
def fix_bootstrap_gallery():
    """Fix image paths in the Bootstrap gallery."""
    # Define paths
    results_dir = "results"
    plots_dir = os.path.join(results_dir, "plots")
    gallery_dir = os.path.join(results_dir, "gallery")
    ...
    js_dir = os.path.join(gallery_dir, "js")
    css_dir = os.path.join(gallery_dir, "css")
...
"""
    ...
    with open(os.path.join(css_dir, "gallery.css"), "w") as f:
        f.write(css_content)
...
"""
    ...
    with open(os.path.join(js_dir, "gallery.js"), "w") as f:
        f.write(js_content)
...
<body>
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-md-3 col-6 mb-4">
                    <div class="stats-card">
                        <div class="h1 mb-2">{total_plots}</div>
                        <div class="text-uppercase small">Total Plots</div>
                    </div>
                </div>
                <div class="col-md-3 col-6 mb-4">
                    <div class="stats-card">
                        <div class="h1 mb-2">{len(categories)}</div>
                        <div class="text-uppercase small">Categories</div>
                    </div>
                </div>
                <div class="col-md-3 col-6 mb-4">
                    <div class="stats-card">
                        <div class="h1 mb-2">{linear_count}</div>
                        <div class="text-uppercase small">Linear Damping</div>
                    </div>
                </div>
                <div class="col-md-3 col-6 mb-4">
                    <div class="stats-card">
                        <div class="h1 mb-2">{quadratic_count}</div>
    ...
    for category, plot_file in all_plots:
        # Use correct relative path from gallery to plots
        rel_path = "../plots/" + category + "/" + os.path.basename(plot_file)
    ...
    # Create redirect file in results directory
...
<body>
    ...
    with open(os.path.join(results_dir, "gallery.html"), "w") as f:
        f.write(redirect_html)
    
    print(f"Fixed Bootstrap gallery with Montserrat font at: {gallery_dir}")
    print(f"The issue with image paths has been resolved.")
    return index_path

if __name__ == "__main__":
    fix_bootstrap_gallery()