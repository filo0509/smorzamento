...
def generate_bootstrap_gallery():
    """Generate a professional Bootstrap gallery with external JS and CSS."""
    # Define paths
    results_dir = "results"
...
<body>
    ...
    for category, plot_file in all_plots:
        rel_path = os.path.relpath(plot_file, gallery_dir)
...
<body>
    ...
    print(f"Bootstrap gallery with Montserrat font generated at: {gallery_dir}")
    return index_path
